...
export const translations: Translations = {
  ...
  insights: { en: 'History', id: 'Riwayat' },
  ...
  historyTitle: { en: 'Scan History', id: 'Riwayat Pemindaian' },
  insightsTitle: { en: 'Nutrizee Insight', id: 'Wawasan Nutrizee' },
  historySubtitle: { en: 'Review your scan history and see the big picture of your nutritional choices.', id: 'Tinjau riwayat pemindaian Anda dan lihat gambaran besar dari pilihan nutrisi Anda.' },
  ...
  noHistory: { en: 'No history yet', id: 'Belum ada riwayat' },
  noHistorySubtitle: { en: 'Your nutrition discoveries and insights will live here.', id: 'Penemuan dan wawasan nutrisi Anda akan ada di sini.' },
  wellnessTrends: { en: 'Wellness Trends', id: 'Tren Kesehatan' },
